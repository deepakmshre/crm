                                    ...
                                    <td className={``}>
                                         <div classNae={``}>
                                            <div className={`w-full flex  justify-center relative`}>
                                                <button onClick={()=>{setGetClick(!getClick)}} ref={buttonRef}
                                                     className={` font-Satoshi font-[500] cursor-pointer text-2xl`}>
                                                    <IoIosInformationCircle />
                                                </button>
                                                {
                                                    getClick ? <p ref={popupRef} className="absolute z-10 top-6 bg-white px-3 py-2 text-md font-medium shadow-md rounded-md inline-block"
                                                              style={{ 
                                                                whiteSpace: 'nowrap', 
                                                                maxWidth: '500px', 
                                                                minWidth: 'auto', 
                                            ...
                                            <div >
                                               ...
                                               {role !== "FOS" && (
                                                    <>
                                                            ...
                                                            !(item.approved === "5" && role !== "superAdmin" && role !== "Admin") &&
                                                            !(item.approved === "10") &&
