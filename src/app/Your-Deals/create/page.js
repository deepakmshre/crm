                                                                    ...
                                                                    <div >
                                                                        ...
                                                                        <div className='flex items-top gap-2 mt-2'>
                                                                            ...
                                                                            <div className="input-group">
                                                                                ...
                                                                                <div className='relative'>
                                                                                    <label for='emirateID' className='absolute cursor-pointer text-xl right-0 mx-auto my-auto'>Visa <span className='text-red-500'>*</span></label>
                                                                                </div>


                                                                                <input onChange={(e) => handleFileChange3(0, 2, e.target.files)} className="block  text-sm text-gray-900 border border-gray-300 cursor-pointer focus:outline-none" aria-describedby="file_input_help" id="emirateID" type="file" title="Visa" />
                                                                        ...
                                                                        <div >
                                                                            ...
                                                                            <div className='flex items-top gap-2 mt-2'>
                                                                              ...
                                                                              <div className='flex items-top gap-2 mt-2'>
                                                                                <div className="input-group" >
                                                                                    <div className='relative'>
                                                                                        <label htmlFor='emirateID' className='absolute cursor-pointer text-xl right-0 mx-auto my-auto'>Visa <span className='text-red-500'>*</span></label>
                                                                                    </div>
                                                                                    <input onChange={(e) => handleFileChange(index, 2, e.target.files)} title="Passport Back" className="block  text-sm text-gray-900 border border-gray-300 cursor-pointer focus:outline-none" aria-describedby="file_input_help" id="Visa" type="file"  />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
