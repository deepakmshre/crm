  ...
  return (
    <RootLayout>
      ...
      <div className=" !overflow-x-scroll mt-2">
        ...
        <div className={` ${collapsed || collapsed2 ? '!w-[13800px]' : collapsed && collapsed2 && '!w-[16000px]'} h-[77vh] w-[9000px]`}>
          <div className="table-container ">
            <table className="table table-auto   scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar scrollbar-thumb-slate-700 scrollbar-track-slate-300">
              <thead className="w-full text-gray-700 relative">
                <tr className="text-md !border-b border-slate-600 ">
                  ...
                  <th className={` !bg-[#D2E8F2]  fixed-column !left-[332px]`}>
              ...
              <tbody className="relative overflow-y-scroll">
                {filteredData.map((row, index) => (
                  <tr key={index} className="border-b border-slate-400">
                    ...
                    <td className={` !bg-[#F1F5F7]  fixed-column !left-[332px]`}>
                    ...
                    }
                  {
                    ...
                    <td scope="row" className="relative z-[1] !px-1 ">
                       <input className=" px-1 py-1 disabled:!border-0 disabled:!bg-[#F1F5F7]" disabled={row.edit === null || row.edit === false} value={row?.Invoicenumber}   onChange={(e) => {
                                                            const newFilteredData = [...filteredData];
                     ...
                     <td scope="row" className="relative z-[1]  !px-1">
                      <NumericFormat thousandSeparator="," className=" px-1 py-1 disabled:!border-0 disabled:!bg-[#F1F5F7]" disabled value={row?.loyaltyBonus ? parseFloat(parseFloat(row?.TotalComission) - parseFloat(row?.loyaltyBonus)).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',') : parseFloat(row?.TotalComission).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',')} />
                    </td>

                    <td scope="row" className="relative z-[1] !px-1" >
                    <NumericFormat thousandSeparator=","  className=" px-1 py-1 disabled:!border-0 disabled:!bg-[#F1F5F7]" disabled value={row?.loyaltyBonus ? parseFloat((parseFloat(row?.TotalComission) - parseFloat(row?.loyaltyBonus))*5 / 100).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',') : (parseFloat(row?.TotalComission)*5/100).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',') } /> 
                    </td>

                    <td scope="row" className="relative z-[1] !px-1 ">
                     <NumericFormat thousandSeparator="," className=" px-1 py-1 disabled:!border-0 disabled:!bg-[#F1F5F7]"  disabled value={row?.loyaltyBonus ? parseFloat(parseFloat(row?.TotalComission) - parseFloat(row?.loyaltyBonus) + (parseFloat(row?.TotalComission) - parseFloat(row?.loyaltyBonus))*5 / 100).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',') : parseFloat(row?.TotalComission).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',')} />
                    </td>

                     

                    <td scope="row" className="relative z-[1] !px-1 ">
                      <NumericFormat className={` px-1 py-1 disabled:!border-0 disabled:!bg-[#F1F5F7]`}   disabled={row.edit === null || row.edit === false} thousandSeparator="," value={parseFloat(String(row?.externalLoyalityBonus).replace(/,/g, '')).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',')}   onChange={(e) => {
                                                            const newFilteredData = [...filteredData];
                                                            newFilteredData[index].externalLoyalityBonus = e.target.value;
                                                            setFilteredData(newFilteredData);
                                                          }}/>
                    </td>

                    <td scope="row" className="relative z-[1] !px-1 ">
                      <NumericFormat className=" px-1 py-1 disabled:!border-0 disabled:!bg-[#F1F5F7]"  disabled={row.edit === null || row.edit === false} value={parseFloat(String(row?.mshreComission).replace(/,/g, '')).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',')} thousandSeparator="," onChange={(e) => {
                          const newFilteredData = [...filteredData];
                          newFilteredData[index].mshreComission = e.target.value;
                          setFilteredData(newFilteredData);
                        }}
                        />
                    </td>
      ...
      agentComissionAED:(parseFloat(row?.mshreComission.replace(/,/g, '')) ) * Number(e.target.value) / 100 
    };
    setFilteredData(newFilteredData);
                    ...
                    <td scope="row" className="relative z-[1] !px-1 ">
                      <NumericFormat className=" px-1 py-1 disabled:!border-0 disabled:!bg-[#F1F5F7]" value={row?.tlComissionPercent}   onChange={(e) => {
                          const newFilteredData = [...filteredData];
                           newFilteredData[index] = {
      ...newFilteredData[index], // Maintain other properties of the row
      tlComissionPercent: Number(e.target.value),
      tlComissionAED:(parseFloat(row?.mshreComission.replace(/,/g, '')) ) * Number(e.target.value) / 100 
    };
    setFilteredData(newFilteredData);
                    ...
                    <NumericFormat className=" px-1 py-1 disabled:!border-0 disabled:!bg-[#F1F5F7]" value={row?.smComissionPercent} max="100" onChange={(e) => {
                          const newFilteredData = [...filteredData];
                           newFilteredData[index] = {
                                  ...newFilteredData[index], // Maintain other properties of the row
                                  smComissionPercent: Number(e.target.value),
                                  smComissionAED:(parseFloat(row?.mshreComission.replace(/,/g, '')) ) * Number(e.target.value) / 100 
                                };
                          setFilteredData(newFilteredData);
                        }}
                        disabled={row.edit === null || row.edit === false}/>
                    ...
                    <td scope="row" className="relative z-[1] !px-1 ">
                      <NumericFormat className=" px-1 py-1 disabled:!border-0 disabled:!bg-[#F1F5F7]" value={row?.exAgentsComissionPercent} max="100" onChange={(e) => {
                          ...
                          newFilteredData[index] = {
                                  ...newFilteredData[index], // Maintain other properties of the row
                                  exAgentsComissionPercent: Number(e.target.value),
                                  exAgentsComissionAED:(parseFloat(row?.mshreComission.replace(/,/g, '')) ) * Number(e.target.value) / 100 
                                };
                          setFilteredData(newFilteredData);
                        }} disabled={row.edit === null || row.edit === false}/>
                    </td>
                    ...
                    <td scope="row" className="relative z-[1] !px-1 ">
                       <NumericFormat className=" px-1 py-1 disabled:!border-0 disabled:!bg-[#F1F5F7]" value={row?.exTLComissionPercent} max="100" onChange={(e) => {
                          const newFilteredData = [...filteredData];
                           ...
                           newFilteredData[index] = {
                                  ...newFilteredData[index], // Maintain other properties of the row
                                  exTLComissionPercent: Number(e.target.value),
                                  exTLComissionAED:(parseFloat(row?.mshreComission.replace(/,/g, '')) ) * Number(e.target.value) / 100 
                                };
                          setFilteredData(newFilteredData);
                        }}
                        disabled={row.edit === null || row.edit === false}/>
                    ...
                    <td scope="row" className="relative z-[1] !px-1 ">
                        ...
                        newFilteredData[index] = {
                                  ...newFilteredData[index], // Maintain other properties of the row
                                  exSMComissionPercent: Number(e.target.value),
                                  exSMComissionAED:(parseFloat(row?.mshreComission.replace(/,/g, '')) ) * Number(e.target.value) / 100 
                                };
                          setFilteredData(newFilteredData);
                        }} disabled={row.edit === null || row.edit === false} />
                    </td>
